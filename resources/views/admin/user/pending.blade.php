...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 text-right">
            <a href="{{ route('user.approve-all') }}" class="btn btn-gradient-primary px-4 mt-0 mb-3"><i
                    class="mdi mdi-plus-circle-outline mr-2"></i>Approve All</a>

            <a href="{{ route('user.delete-all') }}" class="btn btn-gradient-primary px-4 mt-0 mb-3"><i
                    class="mdi mdi-plus-circle-outline mr-2"></i>Delete All</a>
        </div>
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
