        ...
        <div class="col-md-10 mx-auto  slides">
                    ...
                    <div class="row" id="single_gates" key="single_gates">
                        ...
                        <div class="range-slider">
                            <input class="range-slider__range slider" type="range" name="single_gates"
                                id="single_gate" value="0" min="0" max="100">
                    ...
                    <div class="row" id="double_gates" key="double_gates">
                        ...
                        <div class="range-slider">
                            <input class="range-slider__range slider" type="range" id="double_gate"
                                name="double_gates" value="0" min="0" max="100">
            ...
            <div class="action-buttons">
                ...
                <input type="submit" class="button animate-btn " id="submit"
                    value="{{ setting('last_slide_button_text', $loc->id) ?? 'Send Estimate' . '!' }}">
            </div>
        </div>
    </div>
    </div>
...
<script>
    ...
    function check_personal() {
        ...
        if (name == "" || email == "" || phone == "" || isinvalidphone) {
                ...
                if (data.status == 'success') {
                    ...
                    setTimeout(function() {
                        ...
                        if (window.self != window.top) {
                            var directto =
                                "{{ setting('thank_you_page_url', $loc->id) ?? route('estimator.thank-you', $loc->id) }}";
                            window.top.location = directto;
                        } else {
                            var directto =
                                "{{ setting('thank_you_page_url', $loc->id) ?? route('estimator.thank-you') }}";
...
<script>
    ...
    function noRecord(msg) {
        ...
        $('#' + msg1 + ' ' + row).html(`<h3 class="error text-danger text-center">${messages[msg]??msg}</h3>`)
    }
