...
<head>
    ...
    <title>{{ setting( 'software_name',1) ?? 'Instant Fence Quote' }} Terms and Service</title>
    <style>
...
<body>
    ...
    <section id="terms-of-service">
        <div class="card">
            ...
            <p class="paragraph">
                {!! setting('terms_and_conditions', 1) !!}
            </p>
        </div>
    </section>
    <footer>
        <p class="footer-heading">© Copyright {{ date('Y') }}
            {{ setting('software_name', 1) ?? 'Instant Fence Quote' }}. All rights reserved.</p>
    </footer>
</body>
