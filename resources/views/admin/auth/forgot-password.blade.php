...
<head>
    <meta charset="utf-8" />
    <title>Forgot Password - {{ setting('software_name', 1) ?? 'Instant Fence Quote' }}</title>
                    ...
                    <div class="col-lg-5 mx-auto">
                        <div class="card">
                            <div class="card-body p-0 auth-header-box">
                                <div class="text-center p-3">
                                    <a href="index-2.html" class="logo logo-admin">
                                        <img src="{{ asset(setting('software_logo', 1)) ?? asset('assets/images/logo-sm.png') }}" height="50" alt="logo"
                                            class="auth-logo">
                                    </a>
                            ...
                            <div class="card-body bg-light-alt text-center">
                                © {{ date('Y') }} {{ setting('software_name', 1) ?? 'Instant Fence Quote' }}
                            </div>
                            <!--end card-->
                        </div>
                        <!--end col-->
