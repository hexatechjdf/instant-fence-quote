...
@section('content')
            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('custom.list') }}">Custom Field</a></li>
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('custom.save') }}" method="POST" class="card-box">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input type="text" placeholder="Field Name"
                                    ...
                                    value="{{ old('field_name') }}" id="field_name" autocomplete="off">
                                @error('field_name')
